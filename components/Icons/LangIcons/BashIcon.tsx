...
function BashIcon(props: LangIconProps) {
  const mainPartFillColor = useColorModeValue('#293138', '#fafdfa');
  const transparentPartFillColor = useColorModeValue('#fafdfa', '#363a44');

  return (
    <Icon viewBox="0 0 128 128" boxSize={7} {...props}>
      <path fill="none" d="M4.24 4.24h119.53v119.53H4.24z"></path>
      <path
        fill={props.disabled ? '#bbb' : mainPartFillColor}
